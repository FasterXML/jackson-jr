...
import tools.jackson.jr.extension.javatime.JavaTimeReaderWriterProvider;
...
public class JavaTimeValueReadWriteTest
{
    ...
    public void testWrite() throws JSONObjectException, IOException {
        ...
        final String ldtString = json.composeString().addPOJO(ldt).finish();
        ...
        final String odtString = json.composeString().addPOJO(odt).finish();
        ...
        final String zdtString = json.composeString().addPOJO(zdt).finish();
