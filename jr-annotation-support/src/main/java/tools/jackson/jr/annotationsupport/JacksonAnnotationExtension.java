    ...
    extends JacksonJrExtension
{
     ...
     *<ul>
     * <li>Fields: must also have {@link tools.jackson.jr.ob.JSON.Feature#USE_FIELDS} enabled
     *    otherwise {@code Visibility.NONE} is used
     *  </li>
     * <li>Is-getters: must also have {@link tools.jackson.jr.ob.JSON.Feature#USE_IS_GETTERS} enabled
     *    otherwise {@code Visibility.NONE} is used
     *  </li>
